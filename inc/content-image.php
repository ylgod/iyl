...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		if (is_singular()) {
			...
			echo sprintf( '<span class="header-image"><a href="%1$s" title="%2$s" rel="bookmark">', esc_url( get_permalink()), esc_html(get_the_title()) ).'<i class="hjylfont hjyl-camera"></i></a></span>';
		}
		?>
